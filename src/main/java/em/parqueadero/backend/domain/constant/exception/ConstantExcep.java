...
public final class ConstantExcep {
	...
	public static final String VEHICULO_PARQUEADO_CON_ESTA_PLACA = "EXISTE UN VEHICULO PARQUEADO CON ESTA PLACA ";
	public static final String FALLO_SERVICIO_TRM = "TRM ACTUALMENTE NO SE ENCUENTRA DISPONIBLE";
	public static final String VEHICULO_NO_SE_ENCUENTRA_PARQUEADERO = "EL VEHICULO NO SE ENCUENTRA EN EL PARQUEADERO";
	public static final String CILINDRAJE_NO_DEBE_SER_NEGATIVO = "EL CILINDRAJE NO DEBE SER NEGATIVO";
